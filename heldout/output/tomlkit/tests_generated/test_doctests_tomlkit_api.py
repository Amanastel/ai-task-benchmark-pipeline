...
def test_doctest_array():
    """2 documented example(s) for tomlkit.api.array."""
    _run("tomlkit.api", "array")


def test_doctest_inline_table():
    """1 documented example(s) for tomlkit.api.inline_table."""
    _run("tomlkit.api", "inline_table")
...
def test_doctest_value():
    """3 documented example(s) for tomlkit.api.value."""
    _run("tomlkit.api", "value")
