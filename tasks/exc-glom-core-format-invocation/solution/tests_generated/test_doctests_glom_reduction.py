...
def test_doctest_Count():
    """1 documented example(s) for glom.reduction.Count."""
    _run("glom.reduction", "Count")


def test_doctest_Flatten():
    """1 documented example(s) for glom.reduction.Flatten."""
    _run("glom.reduction", "Flatten")


def test_doctest_Fold():
    """1 documented example(s) for glom.reduction.Fold."""
    _run("glom.reduction", "Fold")


def test_doctest_Sum():
    """2 documented example(s) for glom.reduction.Sum."""
    _run("glom.reduction", "Sum")


def test_doctest_flatten():
    """5 documented example(s) for glom.reduction.flatten."""
    _run("glom.reduction", "flatten")
