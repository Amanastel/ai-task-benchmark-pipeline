...
def test_doctest_Delete():
    """3 documented example(s) for glom.mutation.Delete."""
    _run("glom.mutation", "Delete")


def test_doctest_PathDeleteError():
    """1 documented example(s) for glom.mutation.PathDeleteError."""
    _run("glom.mutation", "PathDeleteError")


def test_doctest_delete():
    """2 documented example(s) for glom.mutation.delete."""
    _run("glom.mutation", "delete")
